...
export const experiences: Experience[] = [
  {
    ...
    featured: { src: "/images/experiencias/para-dos.jpg", alt: "Pareja disfrutando el jacuzzi privado frente a la cabaña rodeada de jardines" },
    gallery: [
  ...
  },
  {
    ...
    featured: { src: "/images/experiencias/plan-familiar.jpg", alt: "Corredor y jardín del condominio iluminados al anochecer bajo un cielo estrellado" },
    gallery: [
  ...
  },
  {
    ...
    startingAt: false,
    shortDescription:
      "La cabaña Sirirí ofrece una distribución superior y mayor comodidad para grupos familiares más grandes.",
    longDescription:
    ...
    featured: { src: "/images/experiencias/siriri.jpg", alt: "Cabaña Sirirí con piscina y jardines floridos frente a las montañas" },
    gallery: [
  ...
  {
    slug: "dos-familias",
    name: "Experiencia dos refugios, un lugar",
    concept: "Compartir juntos, conservando la privacidad",
    groupLabel: "Uniendo familias",
    ...
    featured: { src: "/images/experiencias/dos-familias.jpg", alt: "Zona de encuentro iluminada con luces colgantes y reflejos en el lago al anochecer" },
    gallery: [
  ...
  },
  {
    ...
    groupLabel: "Reencuentros mágicos",
    ...
    startingAt: false,
    shortDescription:
      "El condominio completo, sin otros huéspedes: exclusividad total para tu grupo.",
    longDescription:
    ...
    featured: { src: "/images/experiencias/exclusivo.jpg", alt: "Jardines soleados del condominio con el sol entre los árboles y vista a las montañas" },
    gallery: [
